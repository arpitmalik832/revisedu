...
public class PopularCoachingAdapter extends RecyclerView.Adapter<PopularCoachingAdapter.ViewHolder> {
    ...
    public PopularCoachingAdapter(Context context, ICustomClickListener listener) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.mParentLayout.setOnClickListener(view -> listener.onAdapterItemClick(item.getId(), "", TerminalConstant.MODE_POPULAR_COACHING));
