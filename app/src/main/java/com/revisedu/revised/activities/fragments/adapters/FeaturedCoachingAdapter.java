...
public class FeaturedCoachingAdapter extends RecyclerView.Adapter<FeaturedCoachingAdapter.ViewHolder> {
    ...
    public FeaturedCoachingAdapter(Context context, ICustomClickListener listener) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.mParentLayout.setOnClickListener(view -> listener.onAdapterItemClick(item.getId(), "", TerminalConstant.MODE_FEATURED_COACHING));
